...
WINNER_FILE_NAME = 'winner_AI.txt'
OUTFILE = open(WINNER_FILE_NAME, 'wb')
...
def draw_window(win, birds, pipes, base, score, gen):
    ...
    text = STAT_FONT.render("Gen: " + str(gen), 1, (255, 0, 0))
    win.blit(text, (10, 10))
